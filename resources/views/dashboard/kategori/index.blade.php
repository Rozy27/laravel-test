...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <a href="/dashboard/kategori/create" class="btn btn-sm btn-primary position-absolute px-3 py-1" style="right:20px;"> 
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" style="font-size:13px;" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="/dashboard/kategori/{{ $r->slug }}"><i class="fa fa-search"></i> Lihat</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="/dashboard/kategori/{{ $r->slug }}/edit"><i class="fa fa-edit"></i> Ubah</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li>
                    <form action="/dashboard/kategori/{{ $r->slug }}" method="post">
                      @method('delete')
                      @csrf
